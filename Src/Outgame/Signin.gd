...
"priorites_simple" : 33, "priorites_parenthese" : 34, "decomposition" : 35}
...
"_4_Operations/Control/HBoxContainer/questions_priorities/priorites_parenthese",
...
"Literal_calculation/Control/HBoxContainer/Reduce/reduire_parenthese",
